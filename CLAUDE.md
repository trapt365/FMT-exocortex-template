...
> **Общее правило** для всех документов с таблицами РП (WeekPlan, DayPlan, WORKPLAN и т.д.):

- **Активные РП** (pending, in_progress): название **жирным** (`**Название РП**`)
- **Done РП**: зачёркнуть всю строку обычным шрифтом, без bold (`| ~~#~~ | ~~название~~ | ... | ~~done (дата)~~ | ... |`)
