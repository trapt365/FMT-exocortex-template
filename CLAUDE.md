...
> При проектировании нового инструмента, агента, детектора, системы или метода соблюдать строгую последовательность фаз. Пропуск фазы = паттерн P10 (DP.FM.010). Фиксировать как инцидент в журнал инцидентов.

1. **Обещание (Service Clause).** Какое обещание инструмент даёт потребителю? Создать/обновить Service Clause. Обещание содержит: триггер, входы, выходы, время отклика, инвариант (что гарантируется), режим отказа.
...
3. **Роль.** Какую роль в системе играет инструмент? Создать/обновить Role. Роль содержит: обязанности, полномочия, связи с другими ролями, входы/выходы как артефакты.
