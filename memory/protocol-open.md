...
**Шаг 0.** Определить роль пользователя (HD #31). Предложить роль на основе задания, подтвердить:
> (A) Разработчик своего IWE — работа НАД системой (exocortex, CLAUDE.md, протоколы, настройка)
> (B) Пользователь своего IWE — работа В системе (планы, ревью, посты, captures)
> *«Похоже на роль [A/B] — [название]. Верно?»*
> Роль определяет целевые репо и роль Claude.
> Если пользователь также является разработчиком/пользователем платформы — добавить эти роли в список.

**Шаг 1.** Объявить:
> *«**Роль пользователя:** [A/B]. **Роль Claude:** [из каталога DP.ROLE.001 §3.2]. **Работа:** [что]. **РП:** [артефакт]. **Метод:** [как]. **Оценка:** [~Xh]. **Модель:** [текущая] — рекомендую [модель] ([причина]).»*
