...
> **Инструкции:** `/mnt/c/Users/Timur/Documents/IWE/CLAUDE.md` | **Настройте под свою экосистему**
...
4. **Отчёты:** ВСЕ репо в /mnt/c/Users/Timur/Documents/IWE/
...
|---|-----|--------|--------|---------|
| 5 | **Системное мышление: расписание + практика** | 2h | in_progress (80%) | — |
| 2 | **Система питания: meal prep** | 3h | in_progress (30%) | — |
| 6 | **stomresearch: ревью scope** | 1.5h | blocked | — |
