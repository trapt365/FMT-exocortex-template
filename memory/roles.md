...
| R29 | **Аналитик-консультант** | FX1 | Гибрид: research (decomposition, top-down × bottom-up) + consulting (discovery-first, brief, рекомендации). Полигон: hotelresearch / mebelresearch / propresearch / WP-28. Не = R3 Консультант (Q&A), не = R5 Архитектор (системы), не = R7 Триажёр (feedback). |
