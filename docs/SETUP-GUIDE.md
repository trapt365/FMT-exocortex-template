...
Платформа работает на 4 уровнях (тирах). Возможно, ты уже пользуешься ботом — это T1-T3. Это руководство переводит тебя на **T4**, где появляется персональное рабочее пространство с ИИ-агентами.
...
DS-strategy — приватный репо. MEMORY.md — локальный файл. Ничего не публикуется без твоего ведома. MCP-серверы работают без аутентификации (публичная база знаний). WakaTime — отдельный SaaS с собственной политикой приватности.
