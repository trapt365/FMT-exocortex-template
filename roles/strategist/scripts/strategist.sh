...
notify_telegram() {
    local scenario="$1"
    "/mnt/c/Users/Timur/Documents/IWE/DS-exocortex/roles/synchronizer/scripts/notify.sh" strategist "$scenario" >> "$LOG_FILE" 2>&1 || true
}
...
case "$1" in
    ...
    "week-review")
        ...
        KI_REPO="/mnt/c/Users/Timur/Documents/IWE/DS-Knowledge-Index-trapt365"
