...
1. Прочитай `/mnt/c/Users/Timur/Documents/IWE/DS-exocortex/roles/extractor/config/routing.md` — таблицы маршрутизации.
2. Прочитай `/mnt/c/Users/Timur/Documents/IWE/DS-exocortex/roles/extractor/config/feedback-log.md` — лог отклонённых кандидатов. Если capture похож на ранее отклонённый → пропусти.

### Шаг 1: Проверить inbox

1. Прочитай `/mnt/c/Users/Timur/Documents/IWE/DS-strategy/inbox/captures.md`
...
Создай файл отчёта: `/mnt/c/Users/Timur/Documents/IWE/DS-strategy/inbox/extraction-reports/{YYYY-MM-DD}-inbox-check.md`
