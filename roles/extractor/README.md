...
```bash
cd /home/trapt22/IWE/FMT-exocortex-template/roles/extractor
bash install.sh
```
...
bash /home/trapt22/IWE/FMT-exocortex-template/roles/extractor/scripts/extractor.sh inbox-check

# Knowledge Audit
bash /home/trapt22/IWE/FMT-exocortex-template/roles/extractor/scripts/extractor.sh audit
```
