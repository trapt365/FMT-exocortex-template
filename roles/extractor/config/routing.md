...
|-------|------|---------|------|
| _Твой домен (напр. Machine Learning)_ | _PACK-my-domain_ | _MD_ | _/home/trapt22/IWE/PACK-my-domain/pack/my-domain/_ |
...
|---------|--------|-------------|
| _Мой бот_ | _your-org/my-bot_ | _/home/trapt22/IWE/your-org/my-bot/docs/_ |
